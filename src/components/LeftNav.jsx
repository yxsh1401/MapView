...
const LeftNav = ({ onHoverChange }) => {
    const LeftList=[
        {id:1,image:dash,text:"Dashboard"},
        {id:1,image:plan,text:"Planning"},
        {id:1,image:trip,text:"Trips"},
        {id:1,image:master,text:"Masters"},
        {id:1,image:invoice,text:"Invoice"},
        {id:1,image:report,text:"Reports"},
        {id:1,image:control,text:"Control"},
    ]
    const [isHovered, setIsHovered] = useState(false);

    return (
        <div
          className={`relative top-0 left-0 h-screen w-[50px] bg-white border-[0.5px] border-gray-300 transition-all duration-300 ${
        ...
        >
          ...
          <div className="flex flex-col mt-4 space-y-2">
            ...
            {LeftList.map((item, index) => (
              ...
              />
                ...
                <span
                  className={`ml-4 text-sm transition-opacity font-semibold ${
                    isHovered ? "opacity-100" : "opacity-0"
                  }`}
                >
                  <h1 className="text-gray-500 transition duration-300 group-hover:text-blue-600">
                    {item.text}
                  </h1>
                </span>
              </a>
          ...
          <div className="absolute mt-4 left-0 w-full">
            ...
            >
              ...
              <span className="ml-4 text-sm font-semibold text-gray-500 transition duration-300 group-hover:text-blue-600">
                Help
              </span>
            </a>
          </div>
