...
const TrackingCard = ({trip}) => {
  ...
  return (
    ...
    <div className="absolute top-40 left-[920px] transform -translate-x-1/2 bg-white shadow-lg rounded-lg p-[16px] w-[896px] h-[127px] flex-column items-center z-10">
        <div className="flex items-center gap-4 border-b-1 border-gray-300 w-full pb-2 ">
            ...
            <div className="flex justify-between w-full">
                <div>
                    <h2 className="text-[12px] font-regular text-gray-900">{trip.company}</h2>
                    <p className="text-[12px] font-semibold text-gray-500">Arriving in ---</p>
                </div>
                <div>
                    <p className="text-gray-900 text-[12px] font-regular">{trip.dateTime}</p>
                    <p className="text-gray-400 text-[12px] font-regular">{trip.atime}</p>
                </div>
            </div>
        </div>
