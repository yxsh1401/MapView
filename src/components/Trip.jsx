...
const trips = [
  ...
  },
  {
    ...
    image: "pp3", // Add image path here
  },
];
const locations = [
  { origin: "The Bier Library Brewery & Kitchen, Koramangala", destination: "Gopalan Innovation Mall" }
];
...
const TripList = () => {
  ...
  return (
    <div className="border-r-1 border-gray-300 w-[400px]">
      <Map origin={locations[0].origin} destination={locations[0].destination} />
        <div className="pt-2">
